...
plot(x_axis, data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

plot(x_axis, data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(x_axis, data$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
